  ...
  render() {
    return (
      <div style={{ padding: "20px", fontFamily: "sans-serif" }}>
        ...
        {/* ------------------------------------------------------
            XP - Exercise 1 : React Clock. A class component keeps
            year / month / weekday / day / hour / minute / second
            in its state, refreshed every second via setInterval,
            and renders them as a compass-style analog clock face
            plus a plain digital readout.
           ------------------------------------------------------ */}
        <h1>XP - Exercise 1 : React Clock</h1>
        <Clock />
      </div>
    );
  }
